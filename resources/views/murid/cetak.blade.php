...
<head>
    ...
    <title>Cetak ID Card Massal - SLB BC YPASP</title>
    ...
    <style>
        ...
        .info-box {
            ...
            color: #92400E; font-size: 14px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);
        }
        .info-box h4 { margin: 0 0 10px 0; display: flex; align-items: center; font-size: 16px; color: #B45309; }
        ...
        /* ========================================================
           DESAIN ID CARD "KELAS BERAT" (SAMA PERSIS DENGAN PROFIL)
           ======================================================== */
        .id-card-wrapper {
        ...
        .id-card-header {
            ...
            border-bottom: 2mm solid #F59E0B !important; 
        ...
        /* JURUS WADAH PEMAKSA TENGAH KAPSUL KELAS */
        .class-wrapper {
            width: 100%;
            text-align: center;
            margin-top: 2px;
...
<body>
    ...
    <div class="info-box">
        <h4><i class="fas fa-exclamation-triangle mr-2"></i> PENTING: Panduan Cetak ID Card Massal</h4>
        <ul>
            <li>Pastikan Anda menggunakan kertas berukuran <strong>A4</strong> (disarankan kertas PVC/Tebal).</li>
            <li>Centang opsi <strong>"Background Graphics"</strong> (Grafik Latar Belakang) agar warna hijau gelap dan fitur keamanan tercetak sempurna.</li>
    ...
    <div class="header-print">
        <button class="btn-print" onclick="window.print()">
            <i class="fas fa-print mr-2"></i> PRINT ID CARD MASSAL SEKARANG
        </button>
    </div>
        ...
        @foreach($murid as $m)
            <div class="id-card-wrapper">
                ...
                <div class="id-card-body">
                    ...
                    <div class="qr-box">
                        {!! \SimpleSoftwareIO\QrCode\Facades\QrCode::size(80)->generate($m->nis) !!}
                    </div>
                    
                    <h2 class="student-name">{{ strtoupper($m->nama_lengkap) }}</h2>
                    <p class="student-nis">NIS: {{ $m->nis }}</p>
                    
                    <!-- INI DIA KAPSUL KELAS YANG SUDAH DISEMPURNAKAN -->
                    <div class="class-wrapper">
                        <span class="student-class">KELAS: {{ strtoupper($m->kelas) }}</span>
                    </div>
                </div>
